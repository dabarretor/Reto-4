...
if __name__ == "__main__":
    ...
    print("-"*43)
    print(f"total without discount: ${round(table_1.get_price_total(), 2)}") # Output: 18.0
    print(f"Discount applied: ${round(table_1.get_price_total() - table_1.calculate_total_price() , 2)}") # Output: 1.8
    print(f"Total to pay (with discount applied): ${round(table_1.calculate_total_price(), 2)}") # Output: 16.2
